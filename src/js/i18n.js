...
restorationContact: "*For details on service duration and price, please contact us by phone.",
  brandsTitle: "Brands",
      ...
      productStatusInStock: "In stock",
      productStatusPreOrder: "Pre-order",
      productAddToCart: "Add to cart",
      productAddedToCart: "Product added to cart",
      productDecreaseQty: "Decrease quantity",
      productIncreaseQty: "Increase quantity",
      productTabDescription: "Description",
      productTabDelivery: "Delivery",
      productTabPayment: "Payment",
      productTabReturns: "Returns",
      productTabDeliveryText:
        "If the item is in stock, the order is shipped within 24 hours. Delivery is carried out by Nova Poshta. The shipping cost is paid by the recipient according to the carrier's rates.",
      productTabPaymentText:
        "• Cash on delivery\n• Cash on delivery at the post office\n• Bank transfer",
      productTabReturnsText:
        "Cosmetic products cannot be returned after opening the packaging in accordance with Ukrainian law.",
      productRecommendedTitle: "Recommended products",
...
restorationContact: "*Деталі щодо тривалості процедури та ціни ви можете уточнити за телефоном.",
 brandsTitle: "Бренди",
      ...
      priceTitle: "Ціну уточнюйте",
      catalogTitle: "Каталог товарів",
      productCurrency: "грн.",
      productNotFound: "Товар не знайдено",
      productStatusInStock: "В наявності",
      productStatusPreOrder: "Під замовлення",
      productAddToCart: "До кошика",
      productAddedToCart: "Товар додано в кошик",
      productDecreaseQty: "Зменшити кількість",
      productIncreaseQty: "Збільшити кількість",
      productTabDescription: "Опис",
      productTabDelivery: "Доставка",
      productTabPayment: "Оплата",
      productTabReturns: "Повернення",
      productTabDeliveryText:
      ...
      productRecommendedTitle: "Рекомендовані товари",
      productPrevious: "Попередній",
      productNext: "Наступний"
    }
  }
};
